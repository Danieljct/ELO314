 ...
 *
 *         void multi(double u1, double u2, double y1[1], double y2[1])
 *
 *    Simulink version           : 10.1 (R2020a) 18-Nov-2019
 *    C source code generated on : 30-Aug-2020 14:39:36
 *
...
#define S_FUNCTION_NAME  mimo_template
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "multi", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
